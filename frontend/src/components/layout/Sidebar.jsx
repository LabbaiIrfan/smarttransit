...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/chat', icon: <Users className="w-5 h-5" />, label: 'Community Chat' }, // Add this item
  ...
  return (
    <aside className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-gray-900/80 backdrop-blur-lg border-r border-gray-800 hidden lg:block">
      <div className="p-6">
        {/* Logo */}
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800/50"
          >
